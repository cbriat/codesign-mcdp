...
The package ships eight runnable examples under \texttt{examples/} and
the same eight as executed notebooks under \texttt{notebooks/}. Each is
referenced below by its filename.

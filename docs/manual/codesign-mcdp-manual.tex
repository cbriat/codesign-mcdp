...
Calibration values cite \emph{Genta (2014)} for chassis, the
\emph{Bosch Automotive Handbook} for engines, \emph{Heywood (2018)}
and \emph{Pulkrabek (2003)} for ICE thermodynamics,
\emph{Hofmann (2019)} for hybrid topologies, \emph{Naunheimer
(2011)} for transmissions, \emph{Larminie and Lowry (2012)} for
electric powertrain, the \emph{IEA Global EV Outlook 2024} for
battery pricing, and the \emph{EPA Automotive Trends Report} for
fleet averages. Numbers should be understood as ``within published
ranges for production vehicles in the 2020 to 2024 generation,''
not as production-precision OEM data; the framework's contribution
is the compositional analysis, not the specific point values.

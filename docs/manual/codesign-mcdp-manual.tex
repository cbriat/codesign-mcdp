...
(Reinhart \etal\ 2021 [10], Sumi \etal\ 2024 [11]), oxygen uptake
rates and $k_L a$ correlations (BioProcess International 2024),
bioreactor capex (Sustainability Atlas 2026, BioPlan 2025), media
pricing (CHO media market report 2025), and metabolic constraints
from Khattak \etal\ 2010 [8] and Lao \& Toth 1997 [12]. The example
is the first biotech-upstream application in the library and is
intended both as a teaching example for the framework and as a
starting point for discussions with industrial process-development
groups.
...
Calibration values cite Genta and Morello [13] for the chassis, the
Bosch Automotive Handbook [14] for engines, Pulkrabek [15] and
Heywood [16] for ICE thermodynamics, Hofmann [17] for hybrid
topologies, Naunheimer et al.\ [18] for transmissions, the IEA
Global EV Outlook [19] and Larminie and Lowry [22] for the electric
powertrain and battery pricing, Nemry et al.\ [20] for emission
factors, the EPA Automotive Trends Report [21] for fleet averages,
and Mock [23] for mass-versus-mission calibration. Numbers should be
...
Entries [5]--[12] are the parameter-calibration sources for the
monoclonal-antibody bioprocess examples (15 and 16); entries
[13]--[23] are the calibration sources for the full-vehicle co-design
example (17). All calibration values are illustrative, drawn from the
published ranges in these sources, and are not OEM- or product-specific.
...
\begin{enumerate}[label={[\arabic*]},leftmargin=2.5em,start=5]
  \item M.-C. Yoon et al. Effect of culture temperature on antibody
        production in NS0 cells. \emph{Biotechnology Progress}
        19:1383--1386, 2003.
  \item Z. Sou et al. Mild temperature shift in CHO cell cultures.
        \emph{BMC Biotechnology} 15:64, 2015.
  \item C. Trummer et al. Process parameter shifting: effect of pH and
        dissolved oxygen. \emph{Biotechnology and Bioengineering}
        94:1033--1044, 2006.
  \item S. Khattak et al. Feed development for a fed-batch CHO process
        by semi-steady-state analysis. \emph{Biotechnology Progress}
        26:1671--1682, 2010.
  \item N. Gagnon et al. High-end pH-controlled delivery of glucose
        (HIPDOG). \emph{Biotechnology and Bioengineering}
        108:1328--1337, 2011.
  \item J. Reinhart et al. Bioprocessing of recombinant CHO cell lines:
        productivity and product-quality benchmarks.
        \emph{Applied Microbiology and Biotechnology}, 2021.
  \item K. Sumi et al. High-productivity CHO cell-line development for
        therapeutic antibodies. \emph{Journal of Bioscience and
        Bioengineering}, 2024.
...
\begin{enumerate}[label={[\arabic*]},leftmargin=2.5em,start=13]
  ...
  \item P. Mock. \emph{European Passenger Car Market Statistics}.
        International Council on Clean Transportation, 2023.
        (Mass-versus-mission scatter data for calibration.)
\end{enumerate}
